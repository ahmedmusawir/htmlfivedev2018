...
?>
	...
	<!--====  End of The Related Post Block  ====-->	
		...
		<article class="post-content">
			...
			<figure class="center-block" style="margin: 0 auto !important; display: block;">
				<?php if(get_field('blog_single_optin_form_code_individual')) : ?>

					<!-- Signup form for individual posts -->
					<?php the_field('blog_single_optin_form_code_individual'); ?>

				<?php else : ?>	
				<!-- Begin Signup Form Common For All - Default--> 

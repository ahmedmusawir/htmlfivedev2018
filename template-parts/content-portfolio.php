   ...
   <figure class="">
        ...
        <article class="content-block clearfix">
            ...
            <div class="social-icons text-center">
                <a class="btn btn-primary btn-sm" href="#" data-featherlight="#portfolio-single-<?php the_ID(); ?>" style="border: 3px solid white; border-bottom-right-radius: 20px; border-top-left-radius: 20px; color: white;">
                    Click To View
                </a>
            </div>                                                  

...
<div class="modal fade" id="myModal-button" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 585px !important;">
	...
	<div class="content-box container">
			...
			<article class="featured-article">
			    <a class="article-content" href="<?php esc_url( the_permalink()); ?>">
			    	...
			    	<figure class="article-image">
			           	...
			           	<?php the_post_thumbnail('featured-post-size', ['class' => 'img-responsive', 'title' => 'Feature image']); ?>
				...
				<footer class="article-footer">
					...
					<style type="text/css">
						...
						#featured-post .category-name:hover {
							text-decoration: underline !important;
						}
					</style>

			        <div id="featured-post" class="clearfix footer-content">
			        	<?php 
		...
		<div class="col-sm-5 col-md-5 col-lg-5">
			...
			<div class="lead-pg lead-pg-block-1">
				...
				<?php the_field('blog_page_optin_image_ontraport_or_lead_pages_form_code', get_option('page_for_posts')); ?>
